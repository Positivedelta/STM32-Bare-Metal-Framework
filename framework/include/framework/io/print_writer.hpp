...
namespace bpl
{
    class PrintWriter
    {
        ...
        public:
            ...
            //
            bool print(const uint8_t byte) const;
            uint8_t print(const char* text) const;
            uint8_t print(const char* text, const size_t length) const;
            uint8_t print(const std::string_view& text) const;
            uint8_t println(const char* text) const;
            uint8_t println(const std::string_view& text) const;
            uint8_t println() const;
    };
}
