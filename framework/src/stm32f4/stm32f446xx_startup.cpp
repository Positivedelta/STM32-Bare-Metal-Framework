...
void (*vectors[])(void) __attribute__ ((section(".vector_table"))) = {
    ...
    Can1SceIRQ::handler,
    Exti9To5IRQ::handler,
    Timer1BrkTimer9IRQ::handler,
    Timer1UpTimer10IRQ::handler,
    Timer1TrgComTimer11IRQ::handler,
    Timer1CcIRQ::handler,
    Timer2IRQ::handler,
    Timer3IRQ::handler,
    Timer4IRQ::handler,
    ...
    Timer8BrkTimer12IRQ::handler,
    Timer8UpTimer13IRQ::handler,
    Timer8TrgComTimer14IRQ::handler,
    TiM8CcIRQ::handler,
